    ...
    (when doom-treemacs-use-generic-icons
      ...
      (let ((all-the-icons-default-adjust 0))
        (setq treemacs-icon-root-png
              ...
              (concat (all-the-icons-octicon "chevron-down"  :height 0.75 :face 'font-lock-doc-face)
                      "\t")
              treemacs-icon-tag-node-closed-png
              (concat (all-the-icons-octicon "chevron-right" :height 0.9  :face 'font-lock-doc-face)
                      "\t")
        ...
        (treemacs-define-custom-icon (all-the-icons-alltheicon "clojure")
                                     "clj" "cljs" "cljc" "edn")

        (treemacs-define-custom-icon (all-the-icons-alltheicon "terminal")
                                     "sh")

        (treemacs-define-custom-icon (all-the-icons-alltheicon "git")
                                     "gitignore")

        (treemacs-define-custom-icon (all-the-icons-fileicon "gnu")
                                     "Makefile" ".mk")

        (treemacs-define-custom-icon (all-the-icons-alltheicon "javascript")
                                     "js")

        (treemacs-define-custom-icon (all-the-icons-alltheicon "html5")
                                     "html")

        (treemacs-define-custom-icon (all-the-icons-fileicon "elisp")
                                     "el")
