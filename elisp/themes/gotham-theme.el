...
(gotham-set-faces
 '((default :foreground base6 :background base1)
   ...
   (edéiff-even-diff-C :background base2)
   ...
   ;; neotree
   (neo-banner-face :foreground base4 :weight bold)
   (neo-button-face :foreground blue)
   (neo-dir-link-face :foreground base6 :weight bold)
   (neo-expand-btn-face :foreground base4)
   (neo-file-link-face :foreground base5)
